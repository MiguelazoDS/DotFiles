Config {
          font    =  "FiraCode Nerd Font Bold Normal 11.5"
        , additionalFonts = [ "FiraCode Nerd Font Bold Normal 12"      -- Rounded corners for fn=0
                          , "FiraCode Nerd Font Bold Normal 15"
                          , "FiraCode Nerd Font Bold Normal 20"      -- Haskell logo size
                          , "FiraCode Nerd Font Bold Normal 12.7"
                          ]
      , bgColor = "#f5ebc9"
      , alpha = 75
      , border = FullBM 0
      ...
      , persistent = True
      , commands = [
                      Run Com "/home/miguel/.config/xmonad/xmobar_scripts/battery" [] "bat" 10
                    , Run BatteryP ["BAT1"]
    ...
    , Run Cpu ["-t","<fc=#242424><fn=1></fn></fc><fc=#386eab,#242424><fn=0><fc=#8d8f18,#242424> </fc></fn><total>%</fc><fc=#242424><fn=1></fn></fc>","-H","75","--high","#db3e2c,#242424"] 10
    ...
    , Run Com "/home/miguel/.config/xmonad/xmobar_scripts/disk" [] "disk" 10
    , Run Locks
